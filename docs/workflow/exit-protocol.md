...
## 3. Update TASKS.md
- Done: REMOVE the task spec block from "Active Tasks" (or "In Progress") AND add a summary line to "Completed Tasks" with `[x]` and date. A task must appear in exactly one section.
